    ...
    <div>
      <div className="flex justify-end items-center my-4">
        <input
          ...
          className="w-full max-w-md rounded border placeholder:text-[#77AF9C] text-[#77AF9C] placeholder:text-sm border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
